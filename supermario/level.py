...
class Level:
    ...
    def load_level(self):
        ...
        brick_blocks = [
            # (x, y, 数量)
            (300, ground_y - 120, 3),    # 起始区域砖块
            (500, ground_y - 200, 2),    # 高处砖块
            (800, ground_y - 160, 4),    # 第二段地面砖块
            (1200, ground_y - 180, 3),   # 第三段地面砖块
            (1400, ground_y - 260, 2),   # 高处砖块
            (1700, ground_y - 160, 4),   # 第四段地面砖块
            (2000, ground_y - 240, 2),   # 高处砖块
            (2400, ground_y - 180, 3),   # 第五段地面砖块
            (2600, ground_y - 260, 2),   # 高处砖块
            (3000, ground_y - 160, 3),   # 终点区域砖块
        ]
